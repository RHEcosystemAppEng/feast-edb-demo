...
def train_two_tower(two_tower_model: TwoTower, item_df: pd.DataFrame, user_df: pd.DataFrame, interaction_df: pd.DataFrame):
    categories_values = {
    ...
    # traning the model TODO implement me if needed
